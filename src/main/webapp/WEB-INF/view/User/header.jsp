          ...
          <header id="header" class="d-flex align-items-center">
             <div class="container d-flex align-items-center justify-content-between">
               ...
               <a class="navbar-brand" href="index.html">
                 <img src="assets/user/img/cbackground.png" class="logo img-fluid" alt="logo">
                 <span>
               ...
               <nav id="navbar" class="navbar">
                 <ul>
                   ...
                   <li><a class="nav-link scrollto" href="Login?action=booking">Booking</a></li>
                   <li><a class="nav-link scrollto" href="DriverController?action=driver">Driver</a></li>
