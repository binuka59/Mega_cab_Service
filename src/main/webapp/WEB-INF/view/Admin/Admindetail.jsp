...
<body>
        ...
        <%@ include file="adminheader.jsp"%>
                <div class="container-fluid bg-light  ">
                    <div class="container text-center animated bounceInDown">
                        <h1 class="display">Admin Details</h1>
            ...
            <div class="top booking">
                <div class="container-fluid py-6">
                    ...
                    <form action="AdminController?action=addadmin" method="post" >
                    <div class="container">
                         <div class="row">
                             ...
                             <div class=" col-md-4 form-group">
                                <label> Name :</label>
                                <input type="text" name="name" class="form-control" id="name" placeholder="Admin Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required>
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                             ...
                             <div class="col-md-4 form-group mt-3 mt-md-0">
                                ...
                                <input type="text"  class="form-control" name="adpassword"  placeholder="Create a password " required minlength="8">
	...
	<section class="ftco-section">
		<div class="container">
            <h1 class="display">List of Admin</h1>
			<div class="row">
				<div class="col-md-12">
                              ...
                              %>
                                    <tr class="alert" role="alert">
                                      <td>
                                        ...
                                        <td><%= login.getMobile() %></td>
                                        <td> <%= login.getNic() %></td>

                                        <td>
                                          <a href="AdminController?action=editadmin&adminid=<%= login.getId() %>" class="btn btn-info" name="edit" style="width:6rem;">Edit</a>
