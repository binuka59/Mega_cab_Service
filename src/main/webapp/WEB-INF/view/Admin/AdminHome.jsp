...
<body>
	...
	<section class="ftco-section">
		<div class="container">
            <h1 class="display">Toaday Booking</h1>
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-responsive-xl">
						  <thead>
                            ...
                            <tbody>
                                <%
                                    List<Booking> BookingList = (List<Booking>) request.getAttribute("LoginController");
                                ...
                                %>
                                    <tr class="alert" role="alert">
                                        ...
                                        <td class="status"><span class="active"><%= booking.getPicktime()%></span></td>
                                        <td class="status"><span class="active"><%= booking.getPickaddress()%> - <%= booking.getDropaddress()%></span></td>
                                        <td>
                                            <a href="AdminController?action=see&seeid=<%= booking.getId() %>" class="btn btn-info" name="edit">See more.</a>
