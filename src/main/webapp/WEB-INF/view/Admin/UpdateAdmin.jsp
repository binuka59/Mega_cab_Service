<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <%@ page import="com.megacab.model.Login" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
        ...
        <%@ include file="adminheader.jsp"%>
                <div class="container-fluid bg-light  ">
                    <div class="container text-center animated bounceInDown">
                        <h1 class="display">Update Admin Details</h1>
                        <h1 class="message">
            ...
            <div class="top booking">
                <div class="container-fluid py-6">
                              <%
                                  List<Login> AdminList = (List<Login>) request.getAttribute("AdminController");
                                  if (AdminList != null && !AdminList.isEmpty()) {
                                      for (Login login : AdminList) {
                              %>

                    <form action="AdminController?action=updateadmin&id=<%= login.getId() %>" method="post">
                    <div class="container">
                         <div class="row">

                             <div class=" col-md-6 form-group">
                                <label>Admin Name :</label>
                                <input type="text" name="name" class="form-control" id="name" value="<%= login.getName() %>" placeholder="Admin Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                            ...
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                ...
                                <input type="email" class="form-control" name="email" value="<%= login.getEmail() %>" placeholder="Enter E-mail Address"
                            ...
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                ...
                                <input type="tel" class="form-control" name="mobile"  value="<%= login.getMobile() %>" placeholder="Enter Mobile Number" maxlength="10" pattern="\d{10}" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
                                <div class="validate"></div>
                            </div>
                            ...
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                ...
                                <input type="text" class="form-control" name="nic" value="<%= login.getNic() %>" placeholder="Enter NIC Number"
                                       pattern="(\d{12}|\d{9}[Vv])"
